...
namespace AquaBot
{
    ...
    public class Gelbooru : SearchImage
    {
        ...
        public Gelbooru()
        {
            this.BaseURL = new Uri("http://gelbooru.com/index.php?page=dapi&s=post&q=index").GetComponents(UriComponents.StrongAuthority, UriFormat.Unescaped);
            if (this.BaseURL[this.BaseURL.Length - 1] == '/')
                this.BaseURL = this.BaseURL.Substring(0, this.BaseURL.Length - 1);

            this.SearchURL = "http://gelbooru.com/index.php?page=dapi&s=post&q=index";
            this.TagsName = "tags";
            this.PageName = "pid";
